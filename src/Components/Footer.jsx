const Footer = () => {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed=".1"
      className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-founders"
    >
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="text-[7vw] leading-none font-semibold tracking-tighter">
          <h1 className="text-[8vw] font-semibold uppercase tracking-normal leading-none -mb-10">
            EYE-
          </h1>
          <h1 className="text-[8vw] font-semibold uppercase tracking-normal leading-none -mb-10">
            OPENING
      ...
      <div className="w-1/2">
        <div className="text-[8vw] font-semibold uppercase leading-none -mb-10">
          <h1>WEBSITES</h1>
        </div>
        <div className="w-full flex dets font-montreal mt-10">
          <div className="w-1/2">
            ...
            <div className="text-[1.2vw] pt-10">
              ...
              <p>Monika22gmail.com</p>
              <p className="text-[#C1C1C1]">© navi design 2024. Legal Terms</p>
            </div>
          </div>
